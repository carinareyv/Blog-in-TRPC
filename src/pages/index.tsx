...
const HomePage = () => {
  return (
    <div className="flex h-screen w-full flex-col">
      ...
      <section className="grid grid-cols-12 place-items-center w-full h-full">  <main className="col-span-8 w-full border-r border-gray-300 h-full">This is the main screen</main> <aside className="col-span-4 w-full h-full">This is the side bar</aside>
